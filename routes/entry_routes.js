...
import { getEntries, getOneEntry, addEntry, updateEntry, deleteEntry } from '../controllers/entryController.js';
...
router.route('/:id').get(getOneEntry).put(updateEntry).delete(deleteEntry);
